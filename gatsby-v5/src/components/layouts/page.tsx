...
const Page = ({
    ...
    page: any;
    seo: any;
    headerImageName: keyof typeof headerImgAltTextMappings;
    ...
    const altText = headerImgAltTextMappings[headerImageName];
    if (!imageData) {
        throw new Error(`Image data for ${headerImageName} not found`);
    }
    if (!altText) {
        throw new Error(`Alt text for ${headerImageName} not found`);
    }
