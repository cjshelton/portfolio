        ...
        <section className="section-block">
            ...
            <div className="section-content">
                ...
                <p className="section-text">
                    ...
                    achievements so far in my career, as well as showcase some
                    of own personal work, and also introduce a little bit more
                    about me.
                </p>
                <p className="section-text">
                    I graduated from the University of Leeds in Computer
                    Science, and have been in the professional software industry
                    since 2016, with prior experience of working on personal
                ...
                <p className="section-text">
                    ...
                    specialise in full-stack web application development using
                    both ASP.NET Core and Node.js.
                </p>
            </div>
        </section>
        <section className="section-block">
            ...
            <div className="section-content">
                <p className="section-text">
                    ...
                    always focused on application development, specifically for
                    the web.
                </p>
                <p className="section-text">
                    I started out my career at Bluesmith as an intern during my
                    year-long industrial placement in 2014. This was a
                    successful experience for me, leading to a full-time
                    developer position which I still hold today.
                </p>
                <p className="section-text">
                    Due to the nature of our services at Bluesmith, I am lucky
                    to have experienced a variety of different projects, both
                    green and brown-field, for different clients, using a
                    variety of technologies. I have held multiple roles at
                    Bluesmith, including tech and team-lead responsibilities.
                </p>
            </div>
        </section>
        <section className="section-block">
            ...
            <div className="section-content">
                <p className="section-text">
                    Software development is a passion of mine, and something I
                    like to spend my spare time doing also to help me up-skill
                    and experiment with different technologies.
                </p>
                <p className="section-text">
                    I run a tech blog which I post to occasionally to share new
                    experiences, things I have built, and problems I have
                    solved. I also enjoy attending local conferences, namely
                    Leeds Sharp and LeedsJS.
                </p>
                <p className="section-text">
                    I&apos;m not a total techie &mdash; I also have a keen
                    interest in sports, video games, theatre and cooking.
                </p>
            </div>
        </section>
    </div>
